...
- 本项目ygo-definations#linkto("https://github.com/arshtyi/ygo-definations")是ygo-draw#linkto("https://github.com/arshtyi/ygo-draw")的上游之一（以下将此项目链路称为"此链路"），用于说明数据字段定义。
...
#json-property("maxinum", "int")[
    极限怪兽卡的位置，值为$[0,2]$的某整数，对应左·中·右。
] <rd:maximum>

=== maximumAtk

#json-property("maximumAtk", "int")[
    极限怪兽的极限攻击力，值为$[0,+infinity)$的某整数。
] <rd:maximumAtk>
